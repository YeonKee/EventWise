                ...
                <div class="signin-content" style="width: 1600px">
                    <div class="signin-form">
                        ...
                        <div class="form-group form-button d-flex justify-content-center">
                            <input type="submit" name="login" id="login" class="form-submit btn btn-primary" value="Login" style="font-weight: bold" />
                        </div>
                        <div class="d-flex justify-content-center align-items-center flex-column mt-3">
                            <p class="text-center" style="margin-bottom: 5px">Forgotten password? <a href="/students/resetPasswordEmail">Click Here!</a></p>

...
@section('body')
<div class="card mb-4 shadow-sm" style="border-radius: 30px;padding-top:60px;padding-bottom:30px;padding-left:50px;padding-right:50px;margin-left:300px;width:1300px;margin-top:0px;margin-bottom:-500px;">
        {{-- <div class="pagetitle">
            <h1>Event</h1>
            <nav>
                <ol class="breadcrumb">
            ...
            <div class="ml-auto">
                <form class="search-form d-flex align-items-center" method="GET" action="/staffs/events/staffParticipantSearch">
                    ...
                    <button type="submit" title="Search"><i class="bi bi-search"></i></button>
                        ...
                        <h3 class="card-title"  style="font-family:'Poppins';text-align:center; padding-bottom: 25px;">Suggested Nearby Participant(s) </h3>
                        @php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="https://wa.me/{{ $reg->part_contactNo }}?text=I%20am%20{{ $reg->part_name }},%20and%20we%20are%20joining%20the%20same%20event%20{{ $event->name }}.%20Do%20you%20mind%20if%20we%20carpool%20to%20the%20event%20destination?"
                                                   target="_blank"
                                                   title="Contact via WhatsApp">{{ $reg->part_contactNo }} </a></td>

...
@section('body')
    ...
    "> @endif
        ...
        <form id="form1" class="mt-4 h-100" method="POST" action="/event" enctype="multipart/form-data"
            ...
            <div class="seperator">Organizer Details</div>
            ...
            <div class="mb-4 shadow-sm o-class">
                ...
                <div class="form-row mb-4">
                    <div class="col-5 mx-auto">
                        ...
                        <input type="text" class="form-control" id="event_picContactNo" name="event_picContactNo"
                            value="{{ old('event_picContactNo') }}" placeholder="E.g: 0133506462">
                    </div>
                </div>
                ...
                <div class="form-row mb-4">
                    <div class="col-5 mx-auto">
                        ...
                        <input type="text" class="form-control" id="pic_email" name="pic_email"
                            value="{{ old('pic_email') }}" placeholder="E.g: ten@gmail.com">
                    </div>
                </div>

                <div class="seperator">Event Details</div>
                    ...
                    <div class="col-5 mx-auto">
                        <div class="form-group input-group">
                            <label for="event_venueArr" class="o-label">Venue Arrangement:
                                ...
                                <input type="file" class="d-none" name="event_venueArr" accept=".jpg, .jpeg, .png"
                                    capture>
                            </label>
                        </div>
                ...
                <script>
                    $(document).ready(function() {
                        // Function to show/hide fields based on ticket price
                        function toggleFieldsVisibility() {
                            var ticketPrice = parseFloat($('#event_price').val());
                            var showFields = ticketPrice > 0.00;

                            $('#bank_Name_container').toggle(showFields);
                            $('#pic_accNo_container').toggle(showFields);
                            $('#payment_qr_container').toggle(showFields);
                        }

                        // Initial toggle based on page load
                        toggleFieldsVisibility();

                        // Attach an event listener to the ticket price field
                ...
                <div class="form-row mb-4">
                    <div class="col-5 mx-auto">
                        ...
                        </label><br><i>Please put 0.00 for FOC event.</i>
                        <input type="text" class="form-control" id="event_price" name="event_price"
                            value="{{ old('event_price') }}">
                    </div>
                </div>

                <div class="form-row mb-4" id="bank_Name_container">
                    <div class="col-5 mx-auto">
                        ...
                        <input type="text" class="form-control" id="pic_accNo" name="pic_accNo"
                            value="{{ old('pic_accNo') }}" style="margin-top: 10px" placeholder="E.g: 12345678910">
                    </div>
                </div>

                <div class="form-row mb-4" id="payment_qr_container">
                    <div class="col-5 mx-auto">
                        <div class="form-group input-group">
                ...
                <div class="form-row mb-4">
                    <div class="col-5 mx-auto">
                        ...
                        </label> <br><i>Please select 3 weeks from the current date.</i>
                ...
                <div class="form-row mb-4">
                    <div class="col-5 mx-auto">
                        ...
                        </label><br><i>The maximum durations is 5 days only.</i>
                ...
                <div class="form-row mb-4">
                    <div class="col-5 mx-auto">
                        <label for="event_remark" class="o-label">Remarks
                            <span class="text-danger"><b></b>
                                @error('event_remark')
                                    {{ $message }}
                                @enderror
                            </span>
                        </label><br><i>You may leave a message for appoinment/meeting with our staff.</i>
                        <textarea rows="4" cols="50" class="form-control" id="event_remark" name="event_remark"
                            style="resize: none">{{ old('event_remark') }}</textarea>
                    </div>
                </div>
